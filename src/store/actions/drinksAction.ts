...
export const SET_ACTIVE_DRINKS_LIST = 'SET_ACTIVE_DRINKS_LIST';
...
export type SET_ACTIVE_DRINKS_LIST = typeof SET_ACTIVE_DRINKS_LIST;
...
export type Action =
	...
	| { type: FETCH_DRINKS_LIST_SUCCESS; value: { category: string; drinks: IDrink[] } }
	| { type: FETCH_DRINKS_LIST_FAIL }
	| { type: SET_ACTIVE_DRINKS_LIST; value: IDrink[] }
...
export function fetchDrinksListSuccess(value: { category: string; drinks: IDrink[] }): Action {
	return {
...
export function setActiveDrinksList(drinksList: IDrink[]): Action {
	return {
		type: SET_ACTIVE_DRINKS_LIST,
		value: drinksList
	};
}
